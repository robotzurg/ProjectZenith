...
if show_details == true {
	depth = -1298432
	nine_slice_box_stretch(FOCPLR.textboxspr,x-200,y,x-40,y+150);
...
if global.currentturn == "Players" && FOCPLR.selection == "attack" && position_meeting(global.d_mouse_x,global.d_mouse_y,self) && dead == false {
