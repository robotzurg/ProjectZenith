...
nine_slice_box_stretch(par[? "textbox_spr"],0,1,80,60); //Run Button
draw_text(18,15,"Run");
nine_slice_box_stretch(par[? "textbox_spr"],room_width-100,1,room_width,60) //Glitch Button
...
nine_slice_box_stretch(par[? "textbox_spr"],sklx1,btny1,sklx2,btny2); //Skill Button
...
if menu_open == "none" or menu_open != "skills" { 
	nine_slice_box_stretch(par[? "textbox_spr"],itmx1,btny1,itmx2,btny2); 
...
if menu_open = "none" {
	...
	nine_slice_box_stretch(par[? "textbox_spr"],415,btny1,475,btny2);
